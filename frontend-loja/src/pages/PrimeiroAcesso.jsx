...
import { primeiroAcessoConta } from "../services/conta";
...
export default function PrimeiroAcesso() {
    ...
    async function cadastrar(event) {
        ...
        setEnviando(true);
        try {
            await primeiroAcessoConta(Object.fromEntries(dados));
            formulario.reset();
            setConcluido(true);
        } catch (error) {
            setErro(true);
    ...
    return (
        <section className="conta-card conta-cadastro">
          <TituloPagina
            ...
            descricao="Crie uma conta e associe com o seu histórico de cliente físico, para receber novidades e vantagens!"
          />
